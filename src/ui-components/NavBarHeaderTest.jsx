...
export default function NavBarHeaderTest(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "NavBarHeaderTest")}
      {...rest}
    >
      <Flex
        gap="32px"
      ...
      >
        ...
        <Text
          ...
          whiteSpace="pre-wrap"
          children="聯絡我們"
          {...getOverrideProps(overrides, "\u806F\u7D61\u6211\u5011")}
        ></Text>
      </Flex>
      <Flex
        gap="8px"
      ...
      >
        <Button
          ...
          {...getOverrideProps(overrides, "Button39921537")}
        ></Button>
        <Button
          width="unset"
          height="unset"
          ...
          variation="primary"
          children="Sign out"
          {...getOverrideProps(overrides, "Button39921538")}
        ></Button>
      </Flex>
    </Flex>
  );
