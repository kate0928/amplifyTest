...
export default function NoteUI(props) {
  ...
  const vectorThreeEightFourSixFourSixOneNineOnClick = useDataStoreDeleteAction(
    { id: note?.id, model: Note, schema: schema }
  );
  return (
    <Flex
      gap="16px"
          ...
          >
            ...
            >
              <Icon
                ...
                left="0%"
                right="0%"
                {...getOverrideProps(overrides, "Vector38464617")}
              ></Icon>
            </View>
            <View
              width="24px"
            ...
            >
              <Icon
                ...
                right="20.83%"
                onClick={() => {
                  vectorThreeEightFourSixFourSixOneNineOnClick();
                }}
                {...getOverrideProps(overrides, "Vector38464619")}
              ></Icon>
            </View>
          </Flex>
        </Flex>
